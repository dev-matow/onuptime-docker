...
keep the original behaviour: notify owners/admins/responders once.
...
escalation policies (§8), SMS/voice via Twilio, and status-page email
subscriptions (§8). Still consciously deferred, in rough priority order:
