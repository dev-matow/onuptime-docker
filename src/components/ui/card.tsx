...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-[15px] font-medium tracking-[-0.01em] group-data-[size=sm]/card:text-sm",
        className,
      )}
      {...props}
    />
